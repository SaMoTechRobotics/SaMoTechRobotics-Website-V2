    ...
    <div class="navbar-content">
        ...
        <div class="right-items">
            <nav>
                ...
                <a href="/about">
                    <button class:active={page === "about"}>
                        {#if !icons}
                            About
                        {:else}
        ...
        <!--          </a>-->
        <!--&lt;!&ndash;          <a href="/robot">&ndash;&gt;-->
        <!--&lt;!&ndash;            <button class:active={page === "robot"}>Robot</button>&ndash;&gt;-->
        <!--&lt;!&ndash;          </a>&ndash;&gt;-->
        <!--          <a href="/support">-->
